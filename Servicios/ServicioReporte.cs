...
{
    public class ServicioReporte : IServiciosReporte
    {
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetallada(int usuarioId,
                                                                                               int mes,
                                                                                               int año,
                                                                                               dynamic ViewBag)
        {
            ...
            ReporteTransaccionesDetalladas modelo = GenerarReporteTransaccionesDetalladas(fechaInicio, fechaFin,
                                                                                          transacciones);
        ...
        private void AsignarValoresAlViewBag(dynamic ViewBag, DateTime fechaInicio)
        {
            ...
            ViewBag.urlRetorno = httpContext.Request.Path
    ...
    {
        Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetallada(int usuarioId, int mes, int año, dynamic ViewBag);
